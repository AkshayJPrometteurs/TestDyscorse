...
@push('page_title') Add Splash Screen Question @endpush
@section('contents')
    ...
    <div class="card">
        <div class="card-body pt-4">
            <div class="d-flex align-items-center justify-content-between mb-4">
                <div class="col-auto">
                    <h5 class="mb-0 text-capitalize">Add New Question</h5>
                </div>
            ...
            <form action="{{ route('save_question') }}" method="POST">
                ...
                <div class="form-floating">
                    <textarea class="form-control @error('questions') border border-danger @enderror" placeholder="Enter your question" id="question" name="questions" style="height: 150px"></textarea>
