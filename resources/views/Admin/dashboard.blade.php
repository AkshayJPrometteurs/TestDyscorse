        ...
        <div class="col-12 mb-6 mb-lg-0">
            <div class="p-6 h-100 bg-white rounded shadow">
                <div class="row mb-10 align-items-center">
                    <div class="col-12 col-md-auto me-auto mb-4 mb-md-0">
                        <h5 class="mb-0">Users Analysis</h5>
                    </div>
                    <div class="col-12 col-md-auto text-secondary">
                        <div class="d-inline-flex align-items-center text-secondary">
                            <span class="me-2">
                ...
                <div class="chart" data-type="columns-thin"></div>
            </div>
        </div>
    </div>
</section>
...
<script>
    window.onload = function () {
        var chart = new CanvasJS.Chart("chartContainer", {
            ...
            axisX:{interval: 1},
            axisY2:{gridColor: "rgba(1,77,101,.1)"},
            data: [{
                type: "bar",
                name: "companies",
                axisYType: "secondary",
                color: "#9448E3",
                dataPoints: <?php print_r($user_ans_count_data);?>
            }]
        });
        chart.render();
    }
...
<script>
    $(document).ready(function(){
        var data_uc = new Array();
        var dataArray = <?php echo json_encode($countUserData); ?>;
        dataArray.map((data,id)=>{data_uc.push(data)})
        let demoOptions = {
            'columns-thin': {
                series: [{ name: 'Total Users', data: data_uc }],
                chart: {type: 'bar',height: 300,toolbar: {show: false}},
                stroke: {colors: ['transparent'],width: 4},
                colors: ['#8128DE'],
                dataLabels: {enabled: false},
                legend: {show: false},
                plotOptions: {bar: {borderRadius: 3,columnWidth: 12}},
                xaxis: {categories: ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec']},
                __variants: {orange: {colors: ['#F67A28', '#E85444']},
                },
            },
        };
        ...
        function updateCharts() {
            ...
            chartElements.forEach((chartElement) => {
                if (renderedCharts.includes(chartElement)) {return;}
                ...
                if (typeof demoOptions[type] === 'object') {
                    ...
                    if (typeof options['__variants'] === 'object' && typeof options['__variants'][variant] === 'object') {options = { ...options, ...options['__variants'][variant] };}
