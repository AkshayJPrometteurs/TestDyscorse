...
@push('page_title') Add Task Category @endpush
@section('contents')
    ...
    <div class="card">
        <div class="card-body pt-4">
            <div class="d-flex align-items-center justify-content-between mb-4">
                <div class="col-auto">
                    <h5 class="mb-0 text-capitalize">Add Task Category</h5>
                </div>
            ...
            <form action="{{ route('save_task_category') }}" method="POST">
                @csrf
                <div class="mb-4 w-100">
                    <label for="task_category_name" class="form-label">Task Category Name</label>
                    <input type="text" id="task_category_name" class="form-control @error('task_category_name') border border-danger @enderror" name="task_category_name">
