...
@push('page_title') User Pending Request Lists @endpush
@section('contents')
        ...
        <div class="card-body pt-4">
            <div class="row align-items-center justify-content-between mb-4">
                <div class="col-12 col-md-auto">
                    <h5 class="mb-0 text-capitalize">User Pending Request Lists</h5>
                </div>
            </div>
            <div class="table-responsive">
                <table id="dataTable" class="table table-striped" style="width:100%">
                    ...
                    <tbody>
                        @foreach ($request_pending_list as $data)
                            <tr>
                                ...
                                <td class="text-capitalize align-middle text-danger">{{ date('d-M-Y',strtotime($data->created_at)) }}</td>
                            </tr>
                        @endforeach
                    </tbody>
                </table>
